...
# translation
SOURCES = densitymap.py ui_densitymap.py __init__.py densitymapdialog.py
#TRANSLATIONS = i18n/densitymap_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = densitymap

PY_FILES = densitymap.py densitymapdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_densitymap.py
